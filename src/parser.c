...
enum {
  ...
  alias_sym_assignment_operator = 157,
  alias_sym_empty_record_literal = 158,
  alias_sym_merge = 159,
  alias_sym_show_constructor = 160,
  alias_sym_some = 161,
  alias_sym_to_map = 162,
  alias_sym_with_operator = 163,
};
...
static const TSSymbol ts_alias_sequences[PRODUCTION_ID_COUNT][MAX_ALIAS_SEQUENCE_LENGTH] = {
  ...
  [16] = {
    [4] = alias_sym_assignment_operator,
  },
};
...
static const uint16_t ts_parse_table[LARGE_STATE_COUNT][SYMBOL_COUNT] = {
  ...
  [1] = {
    ...
    [sym_equivalent_expression] = STATE(218),
  ...
  [16] = {
    ...
    [sym_equivalent_expression] = STATE(213),
...
static const TSParseActionEntry ts_parse_actions[] = {
  ...
  [381] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_equivalent_expression, 3),
  [383] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_equivalent_expression, 3),
